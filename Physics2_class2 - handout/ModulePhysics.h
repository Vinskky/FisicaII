...
class Stalker
{
	b2Body* body;
public:
	void getPositionBody(float &x, float &y);
	void setBody(b2Body* givenbody);
};
...
public:
	...
	Stalker CreateCircle(int posX, int posY, unsigned int rad);
	bool CreateRectangle(int posX, int posY);
	bool CreateChains();

	p2List<Stalker> bodies;
private:
